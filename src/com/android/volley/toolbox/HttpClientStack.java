...
public class HttpClientStack implements HttpStack {
    ...
    private static void setEntityIfNonEmptyBody(HttpEntityEnclosingRequestBase httpRequest, Request<?> request) throws IOException, AuthFailureError {
        ...
        if (request instanceof MultiPartRequest) {
            ...
            final Map<String, MultiPartParam> multipartParams = multiPartRequest.getMultipartParams();
            final Map<String, String> filesToUpload = multiPartRequest.getFilesToUpload();
            ...
            for (String key : filesToUpload.keySet()) {
                ...
                FilePart filePart = new FilePart(multiPartRequest.getFileKey(), file, null, null);
